...
Full numbers and plots are in [`results/`](results).
...
35 tests. They build their own images, so no photos are committed to the repo.

Two more tests download the real ResNet-50 weights (about 100 MB) and are skipped
by default:
